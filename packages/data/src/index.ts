...
const baseTerritories: TerritorySpec[] = [
  ...
  },
  {
    ...
    reward: { money: 110, research: 40, strategic: 25 },
  ...
  },
  {
    ...
    scenarioId: 'crossroads-defense',
    reward: { money: 155, research: 50, strategic: 34 },
    mapPosition: { x: 40, y: 61 },
  ...
  // === NORTHERN FRONT (Benelux/Scandinavia) ===
  {
    ...
    scenarioId: 'evacuation-run',
    timer: 5,
    reward: { money: 105, research: 38, strategic: 24 },
    mapPosition: { x: 29, y: 36 },
    region: 'Belgium',
    difficulty: 1
  },
  {
  ...
  },
  {
    ...
    scenarioId: 'crossroads-defense',
    timer: 7,
    reward: { money: 160, research: 51, strategic: 35 },
    mapPosition: { x: 43, y: 20 },
  ...
  },
  {
    ...
    scenarioId: 'bridgehead',
    timer: 10,
    reward: { money: 295, research: 82, strategic: 62 },
  ...
  // === DEEP EASTERN FRONT (Ukraine/Russia border) - Final objectives ===
  {
    ...
    scenarioId: 'outpost-night',
    timer: 12,
    reward: { money: 420, research: 110, strategic: 80 },
  ...
  },
  {
    ...
    scenarioId: 'crossroads-defense',
    timer: 10,
    reward: { money: 290, research: 80, strategic: 60 },
    mapPosition: { x: 66, y: 56 },
    requires: ['sector-krakow'],
    region: 'Ukraine',
    difficulty: 4
  },
  {
    ...
    scenarioId: 'bridgehead',
    timer: 11,
    reward: { money: 300, research: 83, strategic: 63 },
  ...
  // === FINAL OBJECTIVES ===
  {
    ...
    scenarioId: 'black-spire-assault',
    timer: 15,
    reward: { money: 600, research: 150, strategic: 100 },
  ...
  {
    id: 'sector-quiet-meridian',
    name: 'Quiet Meridian',
    brief: 'Destroying the heart exposed a fading route home, but a survey team is trapped in the ruins that mark its only stable bearing.',
    scenarioId: 'evacuation-run',
    timer: 12,
    reward: { money: 860, research: 218, strategic: 145 },
    mapPosition: { x: 80, y: 20 },
    requires: ['sector-veil-heart'],
    act: 2,
    region: 'Shatterline',
    difficulty: 5
  },
  {
    id: 'sector-glass-wake',
    name: 'Glass Wake',
    brief: 'The retreating false horizon left a mirrored tide across the southern approach. Seize its last solid crossing before it returns.',
    scenarioId: 'bridgehead',
    timer: 12,
    reward: { money: 875, research: 222, strategic: 148 },
    mapPosition: { x: 80, y: 62 },
    requires: ['sector-quiet-meridian'],
    act: 2,
    region: 'Shatterline',
    difficulty: 5
  },
  {
    id: 'sector-ash-compass',
    name: 'Ash Compass',
    brief: 'A mobile stabilizer can fix the return bearing, but it must cross a forest whose paths rotate around every surviving signal.',
    scenarioId: 'bridgehead',
    timer: 13,
    reward: { money: 890, research: 226, strategic: 150 },
    mapPosition: { x: 89, y: 32 },
    requires: ['sector-glass-wake'],
    act: 2,
    region: 'Shatterline',
    difficulty: 5
  },
  {
    id: 'sector-dawn-anchor',
    name: 'Dawn Anchor',
    brief: 'The final return bearing is locked. Hold the anchor until every surviving formation crosses and the Shatterline closes behind them.',
    scenarioId: 'crossroads-defense',
    timer: 15,
