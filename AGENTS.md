...
- Finish the game: strategic world map, turn-based tactical battles, units, economy, research, and story flavor.
- All copy, fiction and assets must be original to this project. Do not reintroduce third-party manuals, transcriptions or screenshots as design anchors.
...
- Content: unit types, enemy factions, UI text and help must be original wording.
- UX: clear tutorials, tooltips, keyboard and mouse controls, responsive layout, and a consistent military-tactical tone.
...
- Canonical game data lives in `packages/data`; treat it as the design reference.
- Existing assets in `pics/` may be reused where appropriate.
- New assets must be original or carry a recorded licence. Record the source and licence of anything added.
